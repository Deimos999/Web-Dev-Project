...
function EventsPage() {
  ...
  const handleCategoryFilter = async (categoryId) => {
    ...
    try {
      ...
      let data;
      if (categoryId) {
        data = await eventService.getEventsByCategory(categoryId);
      } else {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {events.map((event) => (
            <Link
              ...
              className="group"
            >
              <div className="bg-slate-800 rounded-lg shadow-lg border border-slate-700 overflow-hidden hover:border-blue-500 transition h-full flex flex-col">
                <div 
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <div className="space-y-2 text-sm text-slate-300">
                    ...
                    <p className="flex items-center gap-2">
                      ...
                      $
                      {event.tickets?.reduce((min, t) => Math.min(min, t.price), Infinity) || 0}
                    </p>
                  </div>
                </div>
